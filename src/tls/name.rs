...
/// Format: {base32_encoded_nodeid}.icanact.invalid
...
/// Expects format: {base32_encoded_nodeid}.icanact.invalid
pub fn decode(name: &str) -> Option<NodeId> {
    // Remove the .icanact.invalid suffix if present
...
mod tests {
    ...
    fn test_encode_decode_roundtrip() {
        ...
        assert!(encoded.ends_with(".icanact.invalid"));
    ...
    fn test_decode_without_suffix() {
        ...
        let base32_part = full_name.strip_suffix(".icanact.invalid").unwrap();
