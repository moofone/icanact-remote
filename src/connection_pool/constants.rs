...
type UdpTransportWriter =
    Arc<dyn crate::transport::TransportDatagramWriterDyn>;
    ...
    S: AsyncWrite + Unpin,
{
    ...
    let mut scratch_headers: [MaybeUninit<[u8; HDR_LEN]>; MAX_IOV] = unsafe {
        MaybeUninit::<[MaybeUninit<[u8; HDR_LEN]>; MAX_IOV]>::uninit().assume_init()
    };
