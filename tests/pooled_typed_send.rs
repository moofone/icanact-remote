use icanact_remote::connection_pool::BufferConfig;
use icanact_remote::typed::{encode_typed, encode_typed_pooled, typed_payload_parts};
use icanact_remote::{ChannelId, LockFreeStreamHandle};
...
icanact_remote::wire_type!(WireMsg, "tests::WireMsg");
