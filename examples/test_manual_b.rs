...
async fn main() {
    ...
    tracing_subscriber::fmt()
        .with_env_filter("icanact_remote=debug")
        .init();
    ...
    let handle = GossipRegistryHandle::new_with_transport_stack("127.0.0.1:8002".parse().unwrap(), node_b_keypair.clone().to_secret_key(), Some(config),
