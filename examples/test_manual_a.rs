...
async fn main() {
    ...
    tracing_subscriber::fmt()
        .with_env_filter("icanact_remote=info")
        .init();
    ...
    let handle = GossipRegistryHandle::new_with_transport_stack("127.0.0.1:8001".parse().unwrap(), node_a_keypair.clone().to_secret_key(), Some(config),
